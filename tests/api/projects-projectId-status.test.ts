...
import { PATCH } from '../../src/app/api/projects/[projectId]/status/route';
...
describe('/api/projects/[projectId]/status', () => {
  ...
  describe('PATCH', () => {
    it('should return 401 if user is not authenticated', async () => {
      ...
      const request = new NextRequest(`http://localhost:3000/api/projects/${mockProjectId}/status`, {
        method: 'PATCH',
    ...
    it('should successfully update project status as admin', async () => {
      const { auth } = require('@clerk/nextjs/server');
      auth.mockReturnValue({ userId: mockUserId });
