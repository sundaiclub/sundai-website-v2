              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between max-w-6xl mx-auto">
                <div className="mb-4 md:mb-0">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <span className={`px-4 py-1.5 rounded-full text-sm md:text-base ${
                      project.status === "APPROVED" ? "bg-green-500" : "bg-yellow-500"
                    }`}>
                      {project.status}
                    </span>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="md:grid md:grid-cols-12 md:gap-12">
                ...
                <div className="md:col-span-5 lg:col-span-4">
                  <div className={`p-6 ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
